          ...
          >
            ...
            <div className="row justify-content-center mt-4 w-75 mx-auto">
              <div className="col-3 mx-5 d-flex justify-content-center custom-col-width mb-3">
                <DeliveryOption
                  icon={<House className="m-auto mt-5 custom-icon" />}
                  title="Address"
              ...
              <div className="col-3 mx-5 d-flex justify-content-center custom-col-width mb-3">
                <DeliveryOption
                  icon={<PinAngle className="m-auto mt-5 custom-icon" />}
            ...
            <div className="row justify-content-center mt-4 p-0 w-75 mx-auto">
              <div className="col-3 mx-4 d-flex justify-content-center custom-col-width mb-3">
                <PackageOption
                  icon={<BoxFill className="m-auto mt-5 custom-icon" />}
                  title="Small"
              ...
              <div className="col-3 mx-4 d-flex justify-content-center custom-col-width mb-3">
                <PackageOption
                  icon={<BoxSeamFill className="m-auto mt-5 custom-icon" />}
                  title="Medium"
              ...
              <div className="col-3 mx-4 d-flex justify-content-center custom-col-width mb-3">
                <PackageOption
                  icon={<Box2Fill className="m-auto mt-5 custom-icon" />}
                  title="Large"
